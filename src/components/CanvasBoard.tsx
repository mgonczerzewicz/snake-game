...
import { clearBoard, drawObject, generateRandomPosition, hasSnakeCollided, IObjectBody } from '../utils'
...
const CanvasBoard = ({ height, width }: ICanvasBoard) => {
	...
	useEffect(() => {
		...
		clearBoard(context)
		drawObject(context, snake1, '#91C483')
		drawObject(context, [pos], '#ad1d27') //Draws object randomly
		...
		<>
			<canvas
				...
				style={{
					...
					backgroundColor: 'rgb(251, 207, 40)',
					backgroundImage: `url(https://i.imgur.com/kkwfqQF.png)`,
					backgroundSize: 'auto',
